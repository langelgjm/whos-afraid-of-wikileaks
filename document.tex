...
% Yale Law School
% gabriel.j.michael@gmail.com
% www.gabrieljmichael.com
% Data and code for replication can be found at:
% https://github.com/langelgjm/whos-afraid-of-wikileaks
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
% This puts all floats at the end for manuscript submission
\usepackage[nolists]{endfloat} 
%\usepackage{url} % required to get natbib to correctly process internet resources

% Define a possessive citation command
...
\hline
% Vietnam is deliberately omitted from the columns, since the lower triangle of the matrix is 
